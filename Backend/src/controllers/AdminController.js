...
const { resetTokenStore } = require('./AuthController')
...
module.exports = { getCompanyProfile, listUsers, createUser, updateUser, deleteUser, saveApprovalRule, getApprovalRule }